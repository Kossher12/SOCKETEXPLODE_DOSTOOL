...
VERSION = '0.01' # * YOU NEED REPLACE THIS
NAME_MOD = 'NEBULA.C2' # * YOU NEED REPLACE THIS TOO
...
URL = ['https://raw.githubusercontent.com/Hex1629/SOCKETEXPLODE_DOSTOOL/main/MOD_SOCKETEXPlODE/NEBULAC2/mod_gui.py#leak_gui.py','https://raw.githubusercontent.com/Hex1629/SOCKETEXPLODE_DOSTOOL/main/MOD_SOCKETEXPlODE/NEBULAC2/mod_main.py#main.py'] # ! <--- YOU FILES OF MOD PUT HERE HOW TO PUT LIKE THIS URL#FILES IF YOU WANNA WRITE FOLDER NOT REPLACE FOLDER PLS REPLACE EXAMPLE_FOLDER
...
files_running = 'main.py' # * EXAMPLE I NEED RUN setup.py I REPLACE THIS WITH main.py
