...
URL = ['https://raw.githubusercontent.com/Hex1629/SOCKETEXPLODE_DOSTOOL/main/MOD_SOCKETEXPlODE/NEBULAC2/mod_gui.py#leak_gui.py'] # ! <--- YOU FILES OF MOD PUT HERE HOW TO PUT LIKE THIS URL#FILES IF YOU WANNA WRITE FOLDER NOT REPLACE FOLDER PLS REPLACE EXAMPLE_FOLDER
